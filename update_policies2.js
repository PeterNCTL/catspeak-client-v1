...
const viPaymentPolicy = {
  ...
  section2: {
    title: "2. THANH TOÁN GÓI DỊCH VỤ (SUBSCRIPTION - B2C)",
    items: [
      ...
      "Phí đã thanh toán không được hoàn lại, trừ khi thuộc trường hợp được xem xét theo Mục V.",
    ],
  },
  section3: {
    title: "3. THANH TOÁN TRÊN MARKETPLACE (P2P)",
    items: [
  ...
  section4: {
    title: "4. THANH TOÁN DOANH NGHIỆP (B2B)",
    items: [
  ...
  section5: {
    title: "5. CHÍNH SÁCH HOÀN TIỀN - SUBSCRIPTION (B2C)",
    generalRuleBold: "Nguyên tắc chung:",
    generalRuleText:
      "Các khoản phí đã thanh toán không được hoàn lại, trừ khi pháp luật yêu cầu hoặc thuộc trường hợp đặc biệt dưới đây.",
    subjectiveRuleBold: "Không hoàn tiền vì lý do chủ quan:",
    subjectiveRuleText:
  ...
  section6: {
    title: "6. HOÀN TIỀN TRONG MARKETPLACE",
  ...
  section9: {
    title: "9. GIỚI HẠN TRÁCH NHIỆM VỀ AI (Trí tuệ nhân tạo)",
    items: [
  ...
  section10: {
    title: "10. Liên hệ",
    intro:
      "Nếu có câu hỏi hoặc yêu cầu liên quan đến chính sách bảo mật, vui lòng liên hệ:",
    contact: {
      email: "Email:",
      website: "Website:",
      fanpage: "Fanpage:",
...
const enPaymentPolicy = {
  ...
  section9: {
    title: "9. LIMITATION OF LIABILITY REGARDING AI (Artificial Intelligence)",
    items: [
  ...
  section10: {
    title: "10. Contact",
    intro:
      "If you have any questions or requests related to the privacy policy, please contact:",
    contact: {
      email: "Email:",
      website: "Website:",
      fanpage: "Fanpage:",
...
const zhPaymentPolicy = {
  ...
  section5: {
    title: "5. 退款政策 - 订阅 (B2C)",
    generalRuleBold: "一般原则：",
    generalRuleText: "已支付的费用不可退还，除非法律要求或以下特殊情况。",
    subjectiveRuleBold: "因主观原因不予退款：",
...
function updateFile(filePath, paymentPolicy) {
  ...
  const newText =
    "  paymentPolicy: " +
    JSON.stringify(paymentPolicy, null, 4) +
    ",\n  privacyPolicy: {"
  content = content.replace(
    /paymentPolicy:\s*\{[\s\S]*?\},?\s*privacyPolicy:\s*\{/,
    newText,
  )
